...
var _locationHelper = __webpack_require__(373);

var _locationHelper2 = _interopRequireDefault(_locationHelper);

var _axios = __webpack_require__(374);
...
var debug = __webpack_require__(33)('app:http');
...
var HttpBox = function (_LocationHelper) {
    _inherits(HttpBox, _LocationHelper);

    function HttpBox(url) {
        _classCallCheck(this, HttpBox);

        var _this = _possibleConstructorReturn(this, (HttpBox.__proto__ || Object.getPrototypeOf(HttpBox)).call(this, url));

        _this.pathname = _this.stripSlashes(_this.pathname);
        _this.controller = _this.getControllerAction().controller;
        _this.action = _this.getControllerAction().action;
        return _this;
    }
    ...
    _createClass(HttpBox, [{
        key: 'getInfoLocation',
        value: function getInfoLocation(url) {
            var location = new _locationHelper2.default(url);
            return location;
        }
        ...
        value: function () {
            var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(url, config) {
                var configDefault, _config, response, contentType;
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                ...
                                _config = Object.assign(configDefault, config);
                                _context.next = 5;
                                return _axios2.default.get(url, _config);
        ...
        key: 'post',
        value: function () {
            var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(url, data, config) {
                var configDefault, _config, response, contentType;
                    ...
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            case 0:
                                ...
                                _config = Object.assign(configDefault, config);
                                _context2.next = 5;
                                return _axios2.default.post(url, data, _config);
        ...
        key: 'put',
        value: function () {
            var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(url, data, config) {
                var configDefault, _config, response, contentType;
                    ...
                    while (1) {
                        switch (_context3.prev = _context3.next) {
                            case 0:
                                ...
                                _config = Object.assign(configDefault, config);
                                _context3.next = 5;
                                return _axios2.default.put(url, data, _config);
        ...
        key: 'patch',
        value: function () {
            var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(url, data, config) {
                var configDefault, _config, response, contentType;
                    ...
                    while (1) {
                        switch (_context4.prev = _context4.next) {
                            case 0:
                                ...
                                _config = Object.assign(configDefault, config);
                                _context4.next = 5;
                                return _axios2.default.patch(url, data, _config);
        ...
        key: 'delete',
        value: function () {
            var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(url, config) {
                var configDefault, _config, response, contentType;
                    ...
                    while (1) {
                        switch (_context5.prev = _context5.next) {
                            case 0:
                                ...
                                _config = Object.assign(configDefault, config);
                                _context5.next = 5;
                                return _axios2.default.delete(url, _config);
        ...
        key: 'axiosError',
        value: function axiosError(error) {
    ...
    return HttpBox;
}(_locationHelper2.default);

exports.default = HttpBox;
...
var _template = __webpack_require__(394);
...
var debug = __webpack_require__(33)('app:view');
...
var View = function () {
    ...
    _createClass(View, [{
        ...
        key: 'initMetisMenu',
        value: function initMetisMenu(id) {
            // metisMenu init
            $('#' + id).metisMenu({
                toggle: true
            });
        ...
        key: 'initMessage',
        value: function initMessage(id) {
            var self = this;
            var $deleteButtons = Array.prototype.slice.call(document.querySelectorAll('#' + id + ' button.' + this.opts.closeClass), 0);
        ...
        key: 'isClass',
        value: function isClass(query, className) {
            var _isClass = false;
            // Get all elements for query
            var $elms = Array.prototype.slice.call(document.querySelectorAll(query), 0);
        ...
        key: 'showMessage',
        value: function showMessage(type, messages) {

            var $msg = document.getElementById(this.opts.idMsgBox);
            if ($msg) {
                // Render ejs template
                var _require = __webpack_require__(165),
                    tmplFlashMessage = _require.tmplFlashMessage;

                var compiled = (0, _template2.default)(tmplFlashMessage);
                var html = compiled({ type: type, messages: messages });
                $msg.innerHTML = html;
            }
        }
    }, {
        ...
        value: function showError(err) {
            ...
            if ($msg) {
                ...
                var _require2 = __webpack_require__(165),
                    tmplErrorMessage = _require2.tmplErrorMessage;

                var compiled = (0, _template2.default)(tmplErrorMessage);
                var html = compiled({ error: err });
                $msg.innerHTML = html;
            }
        }
    }, {
        ...
        value: function addMessage(message) {
            ...
            if ($msg) {
                ...
                var $elms = Array.prototype.slice.call(document.querySelectorAll('#' + this.opts.idMsgBox + ' .message-body'), 0);
                // Check if there are any query items
                if ($elms.length > 0) {
                    // Add my message to message-box
                    for (var i = 0, len = $elms.length; i < len; i++) {
                        var $el = $elms[i];
                        var _message = $el.innerHTML;
        ...
        key: 'addListener',
        value: function addListener(query, cb) {
            var $elms = Array.prototype.slice.call(document.querySelectorAll(query), 0);
            if ($elms.length > 0) {
                // Add a click event on each of them
                for (var i = 0, len = $elms.length; i < len; i++) {
        ...
        key: 'removeClass',
        value: function removeClass(query, classForRemove) {
            // Get all elements for query
            var $elms = Array.prototype.slice.call(document.querySelectorAll(query), 0);
            // Check if there are any query items
            if ($elms.length > 0) {
...
var getNative = __webpack_require__(398);
...
//--- Flash template ---//
var tmplFlashMessage = exports.tmplFlashMessage = ['<div class="alert alert-<%- type %> alert-dismissible" role="alert">', '<button class="close" type="button" data-dismiss="alert" aria-label="Close">', '<span aria-hidden="true">×</span>', '</button>', '<div><strong><%- type.toUpperCase() %></strong></div>', '<div class="message-body">', '<% messages.forEach(function(msg){ %>', '<div><%= msg %></div>', '<% }); %>', '</div>', '</div>'].join(' ');

//--- Error template ---//
var tmplErrorMessage = exports.tmplErrorMessage = ['<div class="alert alert-danger alert-dismissible" role="alert">', '<button class="close" type="button" data-dismiss="alert" aria-label="Close">', '<span aria-hidden="true">×</span>', '</button>', '<div><strong>ERROR</strong></div>', '<div class="message-body">', '<div class="text-center">', '<h2><strong><%- error.message %></strong></h2>', '<h3>', '<% if (error.code) { %>', 'Code: <%- error.code %>', '<% } %>', '<% if (error.type) { %>', 'Type: <%- error.type %>', '<% } %>', '</h3>', '</div>', '<div>', '<% if (error.request_info) { %>', 'Request Info: <pre><code><%- error.request_info %></code></pre>', '<% } %>', '</div>', '<div>', '<% if (error.response_data) { %>', 'Response Data: <pre><code><%- error.response_data %></code></pre>', '<% } %>', '</div>', '<div>', '<% if (error.stack) { %>', 'Stack: <pre><%- error.stack %></pre>', '<% } %>', '</div>', '</div>', '</div>'].join(' ');
...
var _exx = __webpack_require__(371);

var _exx2 = _interopRequireDefault(_exx);

var _httpClient = __webpack_require__(138);
...
var debug = __webpack_require__(33)('app:main');

var view = new _view2.default();

var main = function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
        var exx, http, pathname;
        return regeneratorRuntime.wrap(function _callee$(_context) {
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        exx = new _exx2.default();
                        http = new _httpClient2.default();
                        // View init

                        view.init();
                        _context.t0 = http.controller + '/' + http.action;
                        _context.next = _context.t0 === 'exx/client-comp' ? 6 : 9;
                        break;

                    case 6:
                        exx.createComponent();
                        return _context.abrupt('return', 'Path \'exx/client-comp\' completed successfully!');

                    case 9:
                        pathname = http.pathname ? http.pathname : '/';
                        return _context.abrupt('return', 'Path \'' + pathname + '\' completed successfully!');
...
var _base = __webpack_require__(372);
...
var debug = __webpack_require__(33)('app:exx.controller');

var Exx = function (_Base) {
    _inherits(Exx, _Base);

    function Exx() {
        _classCallCheck(this, Exx);

        return _possibleConstructorReturn(this, (Exx.__proto__ || Object.getPrototypeOf(Exx)).call(this));
    }
    ...
    _createClass(Exx, [{
        ...
        value: function createComponent() {
            ...
            var lodashValues = __webpack_require__(444);
            var lodashJoin = __webpack_require__(445);
            var datXml = __webpack_require__(446);
            var datJson = __webpack_require__(447);
            ...
            function component() {
                ...
                var hello = 'Hello';
                var webpack = 'webpack';
                var values = lodashValues({ hello: hello, webpack: webpack });
                debug('Values: ', values);
            ...
            var $el = document.getElementById('client-comp');
            if ($el) {
                $el.appendChild(component());
            }
            var view = new _view2.default();
            var messages = ['Component created on client -  successfully!'];
...
var debug = __webpack_require__(33)('app:base.controller');

var Base = function () {
    function Base() {
        _classCallCheck(this, Base);

        this.req = new _httpClient2.default();
    }
...
var LocationHelper = function () {
    ...
    _createClass(LocationHelper, [{
        key: 'stripSlashes',
        value: function stripSlashes(name) {
        ...
        key: 'getControllerAction',
        value: function getControllerAction() {
            var controller = void 0,
                action = void 0;
            var pathname = this.stripSlashes(this.pathname);
            var arrPathName = pathname ? pathname.split('/') : [];
        ...
        key: 'removeParams',
        value: function removeParams(params) {
            if (!params) {
                this.params = {};
                return this;
            }
        ...
        key: 'serialize',
        value: function serialize(traditional) {
            if (traditional) {
                var result = [],
...
var utils = __webpack_require__(18);
var bind = __webpack_require__(139);
var Axios = __webpack_require__(377);
...
axios.spread = __webpack_require__(393);
...
var defaults = __webpack_require__(99);
var utils = __webpack_require__(18);
var InterceptorManager = __webpack_require__(387);
var dispatchRequest = __webpack_require__(388);
...
var defaults = __webpack_require__(99);
var isAbsoluteURL = __webpack_require__(390);
var combineURLs = __webpack_require__(391);
...
var assignInWith = __webpack_require__(395),
    attempt = __webpack_require__(424),
    baseValues = __webpack_require__(160),
    customDefaultsAssignIn = __webpack_require__(427),
    escapeStringChar = __webpack_require__(428),
    isError = __webpack_require__(158),
    isIterateeCall = __webpack_require__(152),
    keys = __webpack_require__(162),
    reInterpolate = __webpack_require__(163),
...
var copyObject = __webpack_require__(396),
    ...
    keysIn = __webpack_require__(412);
...
var baseIsNative = __webpack_require__(399),
...
var arrayLikeKeys = __webpack_require__(155),
    baseKeysIn = __webpack_require__(422),
    isArrayLike = __webpack_require__(103);
...
/* WEBPACK VAR INJECTION */(function(module) {var root = __webpack_require__(101),
...
var isObject = __webpack_require__(69),
    ...
    nativeKeysIn = __webpack_require__(423);
...
var apply = __webpack_require__(151),
    baseRest = __webpack_require__(149),
    isError = __webpack_require__(158);
...
var escape = __webpack_require__(432),
    reEscape = __webpack_require__(437),
    reEvaluate = __webpack_require__(438),
    reInterpolate = __webpack_require__(163);
...
var escapeHtmlChar = __webpack_require__(433),
    toString = __webpack_require__(164);
...
var basePropertyOf = __webpack_require__(434);
...
// imports
exports.push([module.i, "@import url(http://fonts.googleapis.com/css?family=Playball);", ""]);
...
module.exports = {"compilerOptions":{"module":"commonjs","target":"es5","sourceMap":true},"exclude":["node_modules"]}
